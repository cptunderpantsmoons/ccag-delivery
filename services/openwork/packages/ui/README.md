...
Shared UI primitives for CCAG apps.

This package intentionally ships two framework-specific entrypoints:

- `@ccag/ui/react` for React apps like `ee/apps/den-web`
- `@ccag/ui/solid` for Solid apps like `apps/app`
...
The first shared components live under the `paper` namespace and wrap Paper Design shaders with CCAG-specific defaults and deterministic seed support.
