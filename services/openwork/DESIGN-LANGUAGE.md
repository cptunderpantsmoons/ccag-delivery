# CCAG Design Language

This is the definitive visual system for CCAG product and landing work.

CCAG should feel like a premium work tool: calm, useful, technical, and trustworthy. The design should read as software first, not a flashy marketing site. The goal is clarity with taste, not visual noise.
...
Borders are one of the main structure tools in CCAG.
...
CCAG should have a small set of radii and use them consistently.
...
CCAG copy should feel as disciplined as the UI.
...
### Preferred CCAG Cloud framing

For CCAG Cloud, the primary story is:
...
There are only a few button families in CCAG.
...
This is now one of the clearest CCAG patterns.
...
CCAG has two primary list patterns.
...
CCAG selection should feel confident, not loud.
...
6. Would this still feel like CCAG if all colors were muted?
...
- Landing button + shell primitives: `_repos/ccag/ee/apps/landing/app/globals.css`
- Landing hero and selector patterns: `_repos/ccag/ee/apps/landing/components/landing-home.tsx`
- Landing demo list rhythm: `_repos/ccag/ee/apps/landing/components/landing-app-demo-panel.tsx`
- Cloud dashboard sidebar shell + selected state: `_repos/ccag/ee/apps/den-web/app/(den)/o/[orgSlug]/dashboard/_components/org-dashboard-shell.tsx`
- Share/package modal direction: `_repos/ccag/apps/app/src/app/components/share-workspace-modal.tsx`
- App workspace/session list rhythm: `_repos/ccag/apps/app/src/app/components/session/workspace-session-list.tsx`
