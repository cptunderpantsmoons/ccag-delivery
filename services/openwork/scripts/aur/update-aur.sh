...
VERSION="${TAG#v}"
ASSET_NAME_AMD64="${AUR_ASSET_NAME:-ccag-desktop-linux-amd64.deb}"
ASSET_NAME_ARM64="ccag-desktop-linux-arm64.deb"
ASSET_URL_AMD64="https://github.com/different-ai/ccag/releases/download/${TAG}/${ASSET_NAME_AMD64}"
ASSET_URL_ARM64="https://github.com/different-ai/ccag/releases/download/${TAG}/${ASSET_NAME_ARM64}"
