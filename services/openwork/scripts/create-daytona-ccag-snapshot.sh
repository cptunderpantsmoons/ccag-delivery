...
SNAPSHOT_NAME="${1:-${DAYTONA_SNAPSHOT_NAME:-ccag-runtime}}"
...
LOCAL_IMAGE_TAG="${DAYTONA_LOCAL_IMAGE_TAG:-ccag-daytona-snapshot:${SNAPSHOT_NAME//[^a-zA-Z0-9_.-]/-}}"
...
echo "- ccag-orchestrator@$CCAG_ORCHESTRATOR_VERSION" >&2
