...
const POSTHOG_DISTINCT_ID = process.env.POSTHOG_DISTINCT_ID || "ccag-download"
const GITHUB_REPO = process.env.GITHUB_REPO || "different-ai/ccag"
...
async function fetchReleases() {
  ...
  const headers = {
    ...
    "User-Agent": "ccag-download-stats",
  }
