...
CCAG instance to verify end-to-end behavior of the UI.
...
(OpenCode + CCAG server + React UI) so regressions in wiring — not just
types — get caught.
...
4. Stop the stack with the exact `docker compose -p ccag-dev-... down`
