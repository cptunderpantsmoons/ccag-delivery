...
4. GitHub redirects back to CCAG.
5. CCAG shows the repositories visible to that installation.
...
- App name: choose any unique name, for example `CCAG Den Local`
...
```bash
pnpm --filter @ccag-ee/den-api dev
pnpm --filter @ccag-ee/den-web dev
```
