...
description: SolidJS reactivity + UI state patterns for CCAG
---

## Why this skill exists

CCAG’s UI is SolidJS: it updates via **signals**, not React-style rerenders.
...
This skill captures the patterns we want to consistently use in CCAG.
