...
description: Bridge between CCAG UI and OpenCode runtime
---

## Overview

CCAG communicates with OpenCode via three mechanisms:
...
CCAG can register as an MCP server that OpenCode connects to.
...
### Use cases
- Real-time permission prompts surfaced in CCAG UI.
- Streaming progress updates.
- Custom tools exposed from CCAG (e.g., native file picker).
