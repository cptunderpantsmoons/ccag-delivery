...
export function registerManagedRoutes(app: Hono<AppBindings>) {
  ...
  app.delete(
    ...
    describeRoute({
      ...
      description: "Removes the server-owned cloud signin record for the current CCAG server.",
      responses: withCommonErrorResponses({
  ...
  app.post(
    ...
    describeRoute({
      ...
      description: "Publishes a trusted shared bundle through the configured CCAG bundle publisher.",
      responses: withCommonErrorResponses({
  ...
  app.post(
    ...
    describeRoute({
      ...
      description: "Fetches a trusted shared bundle through the configured CCAG bundle publisher.",
      responses: withCommonErrorResponses({
