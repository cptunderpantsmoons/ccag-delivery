...
const binaryName = process.platform === "win32" ? "ccag-server.exe" : "ccag-server";
...
console.error(
  `Unable to find an CCAG server entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);
