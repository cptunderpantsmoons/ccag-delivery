    ...
    <main className="app-shell">
      ...
      <section className="hero-card panel">
        <div className="hero-copy">
          <span className="eyebrow">CCAG UI demo</span>
          ...
          <p>
            ...
            the gradients that `@ccag/ui/react` will render anywhere else in the repo.
          </p>
        </div>
      ...
      <section className="footer-grid">
        ...
        <div className="panel code-panel">
          ...
          <div className="pill-stack">
            <code className="import-pill">@ccag/ui/react</code>
            <code className="import-pill">@ccag/ui/solid</code>
          </div>
          <pre>{`import { PaperMeshGradient, PaperGrainGradient } from "@ccag/ui/react"
    ...
    <article className="panel preview-card">
      <div className="gradient-surface">
        ...
        <div className="surface-copy">
          <span className="eyebrow on-dark">@ccag/ui/react</span>
          <h2>{title}</h2>
          <p>{subtitle}</p>
        </div>
      </div>
