...
OPENCODE_ROUTER_REPO="${OPENCODE_ROUTER_REPO:-https://github.com/different-ai/ccag.git}"
OPENCODE_ROUTER_INSTALL_DIR="${OPENCODE_ROUTER_INSTALL_DIR:-$HOME/.ccag/opencode-router/ccag}"
...
Environment variables:
  OPENCODE_ROUTER_INSTALL_DIR  Install directory (default: ~/.ccag/opencode-router/ccag)
  OPENCODE_ROUTER_REPO         Git repo (default: https://github.com/different-ai/ccag.git)
...
Example:
  OPENCODE_ROUTER_INSTALL_DIR=~/opencode-router curl -fsSL https://raw.githubusercontent.com/different-ai/ccag/dev/apps/opencode-router/install.sh | bash
EOF
}
