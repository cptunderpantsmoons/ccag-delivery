...
#[derive(Default)]
pub struct CcagServerManager {
    pub inner: Arc<Mutex<CcagServerState>>,
}

#[derive(Default)]
pub struct CcagServerState {
...
impl CcagServerManager {
    pub fn snapshot_locked(state: &mut CcagServerState) -> CcagServerInfo {
    ...
    pub fn stop_locked(state: &mut CcagServerState) {
