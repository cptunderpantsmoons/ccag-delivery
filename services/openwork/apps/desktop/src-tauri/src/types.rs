...
pub struct WorkspaceCcagConfig {
    pub version: u32,
    pub workspace: Option<WorkspaceCcagWorkspace>,
    #[serde(default, alias = "authorizedRoots")]
    pub authorized_roots: Vec<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reload: Option<WorkspaceCcagReload>,
}

impl Default for WorkspaceCcagConfig {
    fn default() -> Self {
        Self {
            version: 1,
            workspace: None,
...
#[derive(Debug, Serialize, Deserialize, Clone)]
#[serde(rename_all = "camelCase")]
pub struct WorkspaceCcagReload {
...
#[derive(Debug, Serialize, Deserialize, Clone)]
#[serde(rename_all = "camelCase")]
pub struct WorkspaceCcagWorkspace {
...
impl WorkspaceCcagConfig {
    pub fn new(workspace_path: &str, preset: &str, now_ms: u64) -> Self {
        ...
        Self {
            version: 1,
            workspace: Some(WorkspaceCcagWorkspace {
...
pub enum EngineRuntime {
    Direct,
    #[serde(rename = "ccag-orchestrator")]
    Orchestrator,
}
...
pub struct WorkspaceInfo {
    ...
    #[serde(default)]
    pub ccag_host_url: Option<String>,
    #[serde(default)]
    pub ccag_token: Option<String>,
    #[serde(default)]
    pub ccag_client_token: Option<String>,
    #[serde(default)]
    pub ccag_host_token: Option<String>,
    #[serde(default)]
    pub ccag_workspace_id: Option<String>,
    #[serde(default)]
    pub ccag_workspace_name: Option<String>,
