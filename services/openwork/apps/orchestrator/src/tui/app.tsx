...
const serviceCycle = ["all", "ccag-orchestrator", "opencode", "ccag-server", "router"];
          ...
          <Show when={state.view === "overview"}>
            <box flexDirection="row" gap={4} paddingTop={1}>
              ...
              <box width={Math.floor(dimensions().width / 2) - 4} flexDirection="column" gap={1}>
                ...
                <text fg={theme.textMuted}>CCAG URL (LAN)</text>
                <text fg={theme.text}>{state.connect.ccagUrl}</text>
                <text fg={theme.textMuted}>CCAG Collaborator Token</text>
                <text fg={theme.text}>{state.connect.ccagToken}</text>
                <Show when={state.connect.ownerToken}>
                  <text fg={theme.textMuted}>CCAG Owner Token</text>
                  <text fg={theme.text}>{state.connect.ownerToken}</text>
                </Show>
                <text fg={theme.textMuted}>CCAG Host Admin Token</text>
