import { DEFAULT_CCAG_PUBLISHER_BASE_URL } from "../lib/publisher";
...
export function resolveConfiguredBundlePublisherOrigin(baseUrl = DEFAULT_CCAG_PUBLISHER_BASE_URL): string | null {
  try {
...
export function describeBundleUrlTrust(bundleUrl: string, baseUrl = DEFAULT_CCAG_PUBLISHER_BASE_URL): BundleUrlTrust {
...
export function isConfiguredBundlePublisherUrl(bundleUrl: string, baseUrl = DEFAULT_CCAG_PUBLISHER_BASE_URL): boolean {
