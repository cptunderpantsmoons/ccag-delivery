...
export const MODEL_PREF_KEY = "ccag.defaultModel";
export const SESSION_MODEL_PREF_KEY = "ccag.sessionModels";
export const THINKING_PREF_KEY = "ccag.showThinking";
export const VARIANT_PREF_KEY = "ccag.modelVariant";
export const LANGUAGE_PREF_KEY = "ccag.language";
export const HIDE_TITLEBAR_PREF_KEY = "ccag.hideTitlebar";
