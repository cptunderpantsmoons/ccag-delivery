...
export type EngineRuntime = "direct" | "ccag-orchestrator";
...
export type ResetCcagMode = "onboarding" | "all";
...
/** CCAG Cloud (Den) org skill surfaced in the Skills catalog (team hub + shared). */
