...
Try browser automation in CCAG right away.
...
- Instead, tell the user the shortest exact steps to connect `Control Chrome` from CCAG's MCP tab, then ask them to retry.
