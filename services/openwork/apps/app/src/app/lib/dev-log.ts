...
type DevRoot = typeof globalThis & {
  __ccagDevLogSeq?: number;
  __ccagDevLogs?: DevLogRecord[];
};
...
export const recordDevLog = (
  ...
  const id = (root.__ccagDevLogSeq ?? 0) + 1;
  root.__ccagDevLogSeq = id;
