...
export function blueprintSessions(config: WorkspaceCcagConfig | null | undefined): WorkspaceBlueprintSessionTemplate[] {
...
export function blueprintMaterializedSessions(config: WorkspaceCcagConfig | null | undefined): WorkspaceBlueprintMaterializedSession[] {
...
export function normalizeWorkspaceCcagConfig(
  value: unknown,
  preset?: string | null,
): WorkspaceCcagConfig {
  const candidate =
    value && typeof value === "object"
      ? (value as Partial<WorkspaceCcagConfig>)
      : {};
