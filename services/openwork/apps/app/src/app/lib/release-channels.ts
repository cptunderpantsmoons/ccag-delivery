/**
 * Release-channel concept for CCAG desktop builds.
 *
...
export const STABLE_UPDATER_ENDPOINT =
  "https://github.com/different-ai/ccag/releases/latest/download/latest.json";

/** Alpha channel's Tauri updater manifest URL (macOS-only, rolling). */
export const ALPHA_UPDATER_ENDPOINT =
  "https://github.com/different-ai/ccag/releases/download/alpha-macos-latest/latest.json";
