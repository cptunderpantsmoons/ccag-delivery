...
import type { CcagSessionMessage, CcagSessionSnapshot } from "../../../../app/lib/ccag-server";
...
export function snapshotToUIMessages(snapshot: CcagSessionSnapshot): UIMessage[] {
...
export function createCcagChatTransport(options: TransportOptions): ChatTransport<UIMessage> {
  return {
    async sendMessages({ messages, abortSignal }) {
      const client = createClient(options.baseUrl, undefined, {
        token: options.ccagToken,
        mode: "ccag",
      });
