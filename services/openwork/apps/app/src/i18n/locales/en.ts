...
export default {
  ...
  "app.deep_link_auth_queued": "Queued the Cloud auth deep link for CCAG.",
  "app.deep_link_remote_queued": "Queued remote worker link. CCAG should move into the connect flow.",
  ...
  "app.error.tauri_required": "This action requires the CCAG desktop app runtime.",
  "app.error_audit_load": "Failed to load audit log.",
  "app.error_auth_failed": "Authentication failed",
  "app.error_auto_compact_scope": "Auto context compaction can only be changed for a local workspace or a writable CCAG server workspace.",
  "app.error_cloud_signin": "Failed to complete CCAG Cloud sign-in.",
  ...
  "app.error_deep_link_unrecognized": "That link is not a recognized CCAG deep link or share URL.",
  "app.error_desktop_signin": "Desktop sign-in completed, but CCAG Cloud did not return a session token.",
  ...
  "app.plugins_hint_disconnected": "CCAG server unavailable. Plugins are read-only.",
  "app.plugins_hint_limited": "CCAG server needs a token to edit plugins.",
  "app.plugins_hint_readonly": "CCAG server is read-only for plugins.",
  ...
  "app.reset_config_ok": "Reset app config defaults. Restart CCAG if any stale settings remain.",
  "app.shared_setup": "Shared setup",
  "app.skill_added": "Skill added",
  "app.skills_hint_disconnected": "CCAG server unavailable. Add the server URL/token in Advanced to manage skills.",
  "app.skills_hint_limited": "CCAG server needs a host token to install/update skills. Add it in Advanced and reconnect.",
  "app.skills_hint_readonly": "CCAG server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "automations.server_needs_token": "CCAG server needs a token to load scheduled tasks.",
  "automations.server_not_ready": "CCAG server not ready.",
  "automations.server_unavailable": "CCAG server unavailable. Connect to sync scheduled tasks.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected CCAG servers.",
  ...
  "config.server_needed_hint": "CCAG server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an CCAG server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "CCAG server",
  ...
  "config.server_sharing_title": "CCAG server sharing",
  "config.server_url_hint": "Use the URL shared by your CCAG server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "CCAG server URL",
  "config.server_url_label": "CCAG Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable CCAG server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "CCAG server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "CCAG server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "CCAG server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable CCAG server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted CCAG worker using a URL and access token.",
  ...
  "dashboard.cloud_signin_title": "Sign in to CCAG Cloud",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted CCAG worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an CCAG server as a workspace.",
  ...
  "dashboard.create_shared_subtitle_signed_out": "Sign in to CCAG Cloud to access workers shared with your organization.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the CCAG server details for this workspace.",
  ...
  "dashboard.ccag_host_hint": "Use the URL shared by your CCAG server.",
  "dashboard.ccag_host_label": "CCAG server URL",
  "dashboard.ccag_host_placeholder": "https://your-server.ccag.app",
  "dashboard.ccag_host_token_hint": "Optional. Paste a collaborator token for routine access or an owner token when this client must answer permission prompts.",
  "dashboard.ccag_host_token_label": "Collaborator or owner token",
  "dashboard.ccag_host_token_placeholder": "Paste your token",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted CCAG worker.",
  "dashboard.remote_server_details_title": "Remote server details",
  "dashboard.remote_workspace_hint": "Track an CCAG server and reconnect anytime.",
  ...
  "dashboard.worker_url_hint": "Paste the URL for the CCAG worker you want to connect to.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and CCAG will reconnect here automatically.",
  ...
  "den.cloud_sleep_hint": "Sign in to CCAG Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_workers_hint": "Open workers directly into CCAG using the same remote-connect flow the app already uses elsewhere.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but CCAG Cloud did not return a session token.",
  "den.error_open_template": "Failed to open {name}.",
  "den.error_open_worker": "Failed to open {name} in CCAG.",
  "den.error_open_worker_fallback": "Failed to open {name}.",
  "den.error_paste_valid_code": "Paste a valid CCAG sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete CCAG Cloud sign-in.",
  ...
  "den.signin_code_note": "Accepts an ccag://den-auth link or the raw one-time grant.",
  "den.signin_link_hint": "If your browser doesn't bounce back into CCAG automatically, paste the sign-in link or one-time code from CCAG Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "ccag://den-auth?... or pasted code",
  "den.signin_title": "Sign in to CCAG Cloud",
  "den.signing_in": "Finishing CCAG Cloud sign-in...",
  ...
  "den.status_browser_signin": "Finish signing in in your browser to connect CCAG.",
  "den.status_browser_signup": "Finish account creation in your browser to connect CCAG.",
  "den.status_cloud_signed_in_as": "Connected CCAG Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected CCAG Cloud.",
  ...
  "den.status_opened_worker": "Opened {name} in CCAG.",
  "den.status_signed_in_as": "Signed in as {email}.",
  "den.status_signed_out": "Signed out and cleared your CCAG Cloud session on this device.",
  "den.sync": "Sync",
  ...
  "identities.connect_server_desc": "Identities are available when you are connected to an CCAG host.",
  "identities.connect_server_title": "Connect to an CCAG server",
  ...
  "identities.reconnect_failed": "Reconnect failed. Check CCAG URL/token and try again.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so CCAG can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, CCAG needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, CCAG needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize CCAG",
  ...
  "mcp.control_chrome_profile_hint": "Control Chrome normally opens a separate Chrome profile. Turn this on if you want CCAG to reuse the Chrome window you already have open.",
  "mcp.control_chrome_profile_title": "2. Choose which Chrome to use",
  "mcp.control_chrome_save": "Save settings",
  "mcp.control_chrome_setup_subtitle": "Turn on Chrome access, then choose whether CCAG should use its own clean profile or attach to the Chrome you already use.",
  "mcp.control_chrome_setup_title": "Set up Control Chrome",
  "mcp.control_chrome_toggle_hint": "When this is on, CCAG adds --autoConnect so the MCP attaches to a Chrome instance you already started.",
  "mcp.control_chrome_toggle_label": "Use my existing Chrome profile",
  "mcp.control_chrome_toggle_off": "CCAG will launch a separate Chrome profile just for automation.",
  "mcp.control_chrome_toggle_on": "CCAG will reuse your current tabs, cookies, and sign-ins.",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from CCAG.",
  ...
  "onboarding.cli_install_commands": "Install OpenCode with one of the commands below, then restart CCAG.",
  ...
  "onboarding.remote_workspace_card_description": "Connect to an CCAG server to access a shared workspace.",
  "onboarding.remote_workspace_card_title": "Connect a remote workspace",
  "onboarding.remote_workspace_description": "Connect to an CCAG server to access a workspace from anywhere.",
  "onboarding.remote_workspace_title": "Connect to CCAG server",
  "onboarding.remove": "Remove",
  "onboarding.resolved_path": "Resolved path",
  "onboarding.run_local": "Run locally",
  "onboarding.run_local_description": "CCAG runs OpenCode locally and keeps your work private.",
  "onboarding.search_notes": "Search notes",
  "onboarding.searching_host": "Connecting to CCAG server...",
  "onboarding.serve_help": "serve --help output",
  "onboarding.show_search_notes": "Show search notes",
  "onboarding.start": "Start CCAG",
  "onboarding.starting_host": "Starting CCAG server...",
  ...
  "onboarding.welcome_title": "How would you like to run CCAG today?",
  "onboarding.windows_install_instruction": "Install OpenCode for Windows, then restart CCAG. Ensure opencode.exe is on PATH.",
  ...
  "scheduled.reload_activate_hint": "OpenCode loads plugins at startup. Reload CCAG to activate opencode-scheduler.",
  "scheduled.reload_activate_title": "Reload CCAG to activate automations",
  "scheduled.reload_openwork": "Reload CCAG",
  ...
  "scheduled.source_remote": "From CCAG server",
  "scheduled.subtitle_local": "Automations that run on a schedule from this device.",
  "scheduled.subtitle_remote": "Automations that run on a schedule from the connected CCAG server.",
  ...
  "session.attachments_connect_server": "Connect to CCAG server to attach files.",
  "session.back": "Back",
  ...
  "session.connect_to_sync": "Connect to CCAG server to sync remote files.",
  ...
  "session.pick_folder_desc": "Choose an existing project or notes folder and CCAG will use it as your workspace.",
  ...
  "session.share_host_url_and_token_required": "CCAG host URL and token are required.",
  "session.share_local_host_not_ready": "Local CCAG host is not ready yet.",
  "session.share_missing_host_url": "Missing CCAG host URL.",
  "session.share_missing_token": "Missing CCAG token.",
  ...
  "session.share_ccag_workers_only": "Share service links are available for CCAG workers.",
  ...
  "session.share_resolve_local_workspace_failed": "Could not resolve this workspace on the local CCAG host.",
  "session.share_resolve_remote_workspace_failed": "Could not resolve this workspace on the CCAG host.",
  ...
  "session.share_sign_in_required": "Sign in to CCAG Cloud in Settings to share with your team.",
  "session.share_skills_set_desc": "Complete skills set from an CCAG workspace.",
  ...
  "session.share_workspace_template_desc": "Full CCAG workspace template with config, commands, skills, and extra .opencode files.",
  ...
  "session.upload_connect_server": "Connect to the CCAG server to upload files to the shared folder.",
  ...
  "session.workspace_setup_desc": "Start with a guided CCAG workspace, or choose an existing folder you want to work in.",
  ...
  "settings.background_checks_desc": "CCAG always checks on launch. Also checks once",
  ...
  "settings.capabilities_title": "CCAG server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point CCAG at a local OpenCode build",
  ...
  "settings.debug_ccag_server_version": "CCAG server: {version}",
  ...
  "settings.deeplink_hint": "Accepts ccag://, ccag-dev://, or a raw supported https://share.openworklabs.com/b/... URL.",
  ...
  "settings.docker_containers_desc": "Force-remove Docker containers launched by CCAG",
  "settings.docker_containers_title": "CCAG Docker containers",
  ...
  "settings.enable_exa_desc": "Applies when CCAG Orchestrator launches OpenCode. Off by",
  ...
  "settings.feedback_title": "Help shape CCAG",
  ...
  "settings.nuke_confirm_dev": "This is irreversible. It WILL delete all CCAG data for this dev build and all isolated OpenCode dev config, auth, cache, data, and state, then quit CCAG. Continue?",
  "settings.nuke_confirm_prod": "This is irreversible. It WILL delete all CCAG data for this dev build and all isolated OpenCode dev config, auth, cache, data, and state, then quit CCAG. Continue?",
  "settings.nuke_failed": "Failed to remove CCAG and OpenCode state.",
  "settings.nuke_hint": "Use this only when you want to fully reset the desktop app and its OpenCode runtime state.",
  "settings.nuke_success": "Removed CCAG and OpenCode state. CCAG is closing...",
  "settings.off": "Off",
  "settings.offline": "Offline",
  "settings.on": "On",
  "settings.open_deeplink_action": "Opening...",
  "settings.open_deeplink_button": "Hide",
  "settings.open_deeplink_desc": "Paste an CCAG deeplink or share URL to open it.",
  ...
  "settings.ccag_config_sidecar_desc": "Config and approvals sidecar.",
  "settings.ccag_diagnostics_title": "CCAG server diagnostics",
  "settings.ccag_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.ccag_server_label": "CCAG server",
  ...
  "settings.quit_hint": "CCAG quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect CCAG server.",
  "settings.reconnected": "Reconnected to CCAG server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears CCAG cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears CCAG cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. CCAG will restart.",
  ...
  "settings.reset_onboarding_description": "Clears CCAG preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears CCAG local preferences and workspace onboarding markers.",
  "settings.reset_ccag_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside ccag-dev-data.",
  "settings.reset_ccag_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside ccag-dev-data.",
  "settings.reset_ccag_title": "Reset CCAG + OpenCode state",
  ...
  "settings.restart_blocked_message": "CCAG needs to restart to finish this update. To avoid interrupting your current work, install is paused until your active runs finish or you stop them.",
  ...
  "settings.restart_ccag_server": "Restarting...",
  ...
  "settings.runtime_desc": "Status for your local engine and CCAG server.",
  ...
  "settings.tab_description_appearance": "Adjust how CCAG looks across desktop, system theme, and app chrome.",
  ...
  "settings.tab_description_den": "Manage your CCAG Cloud connection, hosted workers, and workspace access.",
  "settings.tab_description_extensions": "Manage MCP apps and OpenCode plugins for this workspace.",
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected CCAG workspace plus its runtime connection.",
  ...
  "settings.updates_desc": "Keep CCAG up to date.",
  ...
  "share.cloud_signin_note": "CCAG Cloud opens in your browser and returns here after sign-in.",
  ...
  "share.option_team_desc": "Save this workspace template to your active CCAG Cloud organization.",
  ...
  "share.subtitle_template_team": "Save a workspace template to your active CCAG Cloud organization.",
  "share.team_intro": "Save this template to your active CCAG Cloud organization so teammates can open it later from Cloud settings.",
  ...
  "share.template_item_config_desc": "Reusable commands plus CCAG/OpenCode config.",
  ...
  "share_skill_destination.connect_remote_desc": "Attach an CCAG host, then choose it from the list to import this skill.",
  "share_skill_destination.connect_remote_hint": "Attach an CCAG host, then choose it from the list to import this skill.",
  ...
  "skills.add_ccag_hub": "Add CCAG Hub",
  ...
  "skills.cloud_install_need_server": "Connect to an CCAG server with skills write access to install team skills on this worker.",
  ...
  "skills.cloud_section_subtitle": "Skills shared with you through CCAG Cloud — including team skill hubs you can access.",
  ...
  "skills.cloud_sign_in_hint": "Sign in to CCAG Cloud to browse team and org skills.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected CCAG server.",
  ...
  "skills.share_chooser_subtitle": "Save to your CCAG Cloud organization or publish a public install link.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active CCAG Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active CCAG Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "CCAG Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full CCAG features",
  ...
  "system.reload_body_default": "CCAG detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "CCAG detected OpenCode configuration changes. Reload the engine to apply them.",
