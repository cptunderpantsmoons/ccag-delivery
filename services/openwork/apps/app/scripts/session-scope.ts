...
const starterRoot = "/Users/test/CCAG/starter";
const otherRoot = "/Users/test/CCAG/second";
...
try {
  ...
  await step("windows create and list use the same transport directory", () => {
    ...
    const winRoot = String.raw`C:\Users\Test\CCAG\starter`;
    ...
    const verbatimDriveRoot = String.raw`\\?\C:\Users\Test\CCAG\starter`;
    assert.equal(toSessionTransportDirectory(verbatimDriveRoot), String.raw`C:\Users\Test\CCAG\starter`);
    assert.equal(describeDirectoryScope(verbatimDriveRoot).normalized, "c:/users/test/ccag/starter");
  });
