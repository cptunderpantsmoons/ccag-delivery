// components/openwork/session-list.tsx
'use client';
...
export function OpenWorkSessionList() {
  const { sessions, currentSessionId, setCurrentSessionId, createSession, isConnected } = useOpenWork();
